...
HINT: At the castles' back wall you can see the drawbridge gaurdtower is
currently raised. You are trapped in the castle.
...
def drawbridge_gaurdtower():
    ...
    drawbridge_gaurdtower_string_if = """
You are in the gaurdtower next to the drawbridge

HINT: You see that the pully apparatus, that raises and lowers the
drabridge, is in disrepair. The metal chain is rusted and the wooden
gears are rotten. The blacksmith can work with metal and the carpenter
is the expert on wood.

    -Type "a" to stay here
    -Type "b" to go back to the courtyard
"""

    drawbridge_gaurdtower_string_elif_1 = """
You are in the gaurdtower next to the drawbridge

HINT:The blacksmith has replaced the rusted chain with a shiny new
one but the wooden gears are still rotten. the carpenter is the expert
on wood.
...
"""
    ...
    drawbridge_gaurdtower_string_elif_2 = """
You are in the gaurdtower next to the drawbridge

HINT: The carpenter has replaced the rotten gears with new ones but the
metal chain is still rusty. The blacksmith can work with metal.

    -Type "a" to stay here
    -Type "b" to go back to the courtyard
"""

    drawbridge_gaurdtower_string_elif_3 = """
You are in the gaurdtower next to the drawbridge

HINT: You see that the pully apparatus, that raises and lowers the
drabridge, is repaired and you have lowered the drawbridge! You and
your people are ready to make your escape!

    -Type "a" to stay here
    -Type "b" to go back to the courtyard
"""

    drawbridge_gaurdtower_string_elif_4 = """
You are in the gaurdtower next to the drawbridge

HINT: You see that the pully apparatus, that raises and lowers the
drabridge, is repaired!

    -Type "a" to stay here
    -Type "b" to go back to the courtyard
    -Type "c" to lower the drawbridge
"""

    drawbridge_gaurdtower_string_elif_5 = """
You are in the gaurdtower next to the drawbridge

HINT: The carpenter has removed the rotten wooden gears but they
still need to be replaced. The rusty metal chain is still in place.
...
"""
    ...
    if "rusty chain" in pully and "rotten gears" in pully:
        ...
        print(drawbridge_gaurdtower_string_if)
        where_to = input("> ")
        ...
        print(drawbridge_gaurdtower_string_elif_1)
        where_to = input("> ")
        ...
        print(drawbridge_gaurdtower_string_elif_2)
        where_to = input("> ")
        ...
        print(drawbridge_gaurdtower_string_elif_3)
        where_to = input("> ")
        ...
        print(drawbridge_gaurdtower_string_elif_4)
        where_to = input("> ")
        ...
        print(drawbridge_gaurdtower_string_elif_5)
        where_to = input("> ")
        ...
        print(drawbridge_gaurdtower_string_else)
        where_to = input("> ")
...
def nw_gaurd_tower():
    ...
    nw_gaurd_tower_string_intro = """
You are at the top of the north west gaurd tower. Looking over the
tower's battlements you can see the sea of shambling zombies futilely
trying to break into the castle.

HINT: There is a gaurd on duty up here.
"""

    nw_gaurd_tower_string_if = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
"""

    nw_gaurd_tower_string_if_elif_1 = """
...
"""
    ...
    nw_gaurd_tower_string_elif_1 = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
    -Type "d" to talk to the gaurd
"""

    nw_gaurd_tower_string_elif_1_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    nw_gaurd_tower_string_elif_1_elif_2 = """
...
"""
    ...
    nw_gaurd_tower_string_else = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
"""

    nw_gaurd_tower_string_else_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    print(nw_gaurd_tower_string_intro)

    if bridge_problem_chain_explained <= 1:
        print(nw_gaurd_tower_string_if)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(nw_gaurd_tower_string_if_elif_1)
            nw_gaurd_tower()
        else:
            nw_gaurd_tower()

    elif bridge_problem_chain_explained > 1 and "nw" not in gt_activated:
        print(nw_gaurd_tower_string_elif_1)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(nw_gaurd_tower_string_elif_1_elif_1)
            nw_gaurd_tower()
        elif "d" in what_to_do:
            print(nw_gaurd_tower_string_elif_1_elif_2)
        ...
        print(nw_gaurd_tower_string_else)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(nw_gaurd_tower_string_else_elif_1)
            nw_gaurd_tower()
        else:
            nw_gaurd_tower()
...
def sw_gaurd_tower():
    ...
    sw_gaurd_tower_string_if = """
You are at the top of the south west gaurd tower.

HINT: You find yourself next to a gaurd on duty. He looks very ill
with a pallor to his skin, glassy eyes and sweat stained clothes.
You decide to keep your eyes on him. The last thing you need is a
plague breaking out in the middle of a seige. Looking over the
tower's battlements you can see, to the west, the sea of shambling
zombies futilely trying to break into the castle and, to the south,
you see the chasam over which you plan to make your escape. From time
to time a zombie gets pushed over the chasm's edge by the weight of
the hoard. They fall listless and uncomprehending to the impact of
their second death.
...
"""
    ...
    sw_gaurd_tower_string_if_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    sw_gaurd_tower_string_else = """
You are at the top of the south west gaurd tower. The bloody body of
the dead gaurd lies on the tower stones where you left it.
...
"""
    ...
    sw_gaurd_tower_string_else_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    if bridge_problem_chain_explained <= 1:
        print(sw_gaurd_tower_string_if)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(sw_gaurd_tower_string_if_elif_1)
            sw_gaurd_tower()
        else:
            sw_gaurd_tower()

    elif bridge_problem_chain_explained > 1 and "sw" not in gt_activated:
        print(sw_gaurd_tower_string_elif_1)
        zombie_battle()
    else:
        print(sw_gaurd_tower_string_else)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(sw_gaurd_tower_string_else_elif_1)
            sw_gaurd_tower()
        else:
            sw_gaurd_tower()
...
Type "a" to shove the zombie away and draw your sword
Type "b" to draw your knife
Type "c" to mash the zombie in the face with your armored fist?
"""

    zombie_battle_string_if = """
...
"""
    ...
    print(zombie_battle_string_intro)
    fight = input("> ")

    if fight == "a":
        print(zombie_battle_string_if)
        print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
        bridge_problem_chain_explained += 1
        print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
        print(f"gt_activated: {gt_activated}.")
        ...
        print(zombie_battle_string_elif_1)
        print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
        bridge_problem_chain_explained += 1
        print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
        print(f"gt_activated: {gt_activated}.")
        ...
        print(f"gt_activated: {gt_activated}.")
        blacksmith()
    elif fight == "c" and face_smashes < 1:
        print(zombie_battle_string_elif_2)
        ...
        print(zombie_battle_string_elif_3)
        print(f"\'face_smashes\' is: {face_smashes}.")
        face_smashes = face_smashes + 1
        print(f"now \'face_smashes\' is: {face_smashes}.")
        zombie_battle()
    elif fight == "c" and face_smashes >= 3 and face_smashes < 6:
        print(zombie_battle_string_elif_4)
        print(f"\'face_smashes\' is: {face_smashes}.")
        face_smashes = face_smashes + 1
        print(f"now \'face_smashes\' is: {face_smashes}.")
        zombie_battle()
    elif fight == "c" and face_smashes >= 6 and face_smashes < 9:
        print(zombie_battle_string_elif_5)
        print(f"\'face_smashes\' is: {face_smashes}.")
        face_smashes = face_smashes + 1
        print(f"now \'face_smashes\' is: {face_smashes}.")
        zombie_battle()
    elif fight == "c" and face_smashes == 9:
        print(zombie_battle_string_elif_6)
        print(f"\'face_smashes\' is: {face_smashes}.")
        face_smashes = face_smashes + 1
        print(f"now \'face_smashes\' is: {face_smashes}.")
        zombie_battle()
    elif fight == "c" and face_smashes == 10:
        print(zombie_battle_string_elif_7)
        print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
        bridge_problem_chain_explained += 1
        print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
        print(f"gt_activated: {gt_activated}.")
...
def ne_gaurd_tower():
    ...
    ne_gaurd_tower_string_intro = """
You are at the top of the north east gaurd tower. Looking over the
tower's battlements you can see the sea of shambling zombies futilely
trying to break into the castle.

HINT: You find yourself next to a gaurd on duty.
"""

    ne_gaurd_tower_string_if = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
"""

    ne_gaurd_tower_string_if_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    ne_gaurd_tower_string_elif_1_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    ne_gaurd_tower_string_elif_1_elif_2 = """
You walk over to the gaurd, explain the blacsmith's need for
metal and politley ask him to go give her his sword. He heads
off to go do that. You head back to the courtyard.
"""

    ne_gaurd_tower_string_else = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
"""

    ne_gaurd_tower_string_else_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    print(ne_gaurd_tower_string_intro)

    if bridge_problem_chain_explained <= 1:
        print(ne_gaurd_tower_string_if)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(ne_gaurd_tower_string_if_elif_1)
            ne_gaurd_tower()
        else:
            ne_gaurd_tower()

    elif bridge_problem_chain_explained > 1 and "ne" not in gt_activated:
        print(ne_gaurd_tower_string_elif_1)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(ne_gaurd_tower_string_elif_1_elif_1)
            ne_gaurd_tower()
        elif "d" in what_to_do :
            print(ne_gaurd_tower_string_elif_1_elif_2)
            print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
            bridge_problem_chain_explained += 1
            print(f"bridge_problem_chain_explained: {bridge_problem_chain_explained}.")
            print(f"gt_activated: {gt_activated}.")
        ...
        print(ne_gaurd_tower_string_else)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(ne_gaurd_tower_string_else_elif_1)
            ne_gaurd_tower()
        else:
            ne_gaurd_tower()
...
def se_gaurd_tower():
    ...
    se_gaurd_tower_string_intro = """
You are at the top of the south east gaurd tower.

HINT: You find yourself next to a gaurd on duty. Looking over the tower's
battlements to the east you can see the sea of shambling zombies futilely
trying to break into the castle. To the south you see the chasam over which
you plan to make your escape. From time to time a zombie gets pushed over the
chasm's edge by the weight of the hoard. They fall listless and uncomprehending
to the impact of their second death.
"""

    se_gaurd_tower_string_if = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
"""

    se_gaurd_tower_string_if_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    se_gaurd_tower_string_elif_1_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    se_gaurd_tower_string_elif_1_elif_2 = """
You walk over to the gaurd, explain the blacsmith's need for
metal and politley ask him to go give her his sword. He heads
off to go do that. You head back to the courtyard.
"""

    se_gaurd_tower_string_else = """
    -Type "a" to stay here,
    -Type "b" go back to the courtyard
    -Type "c" to shoot arrows at the zombies
"""

    se_gaurd_tower_string_else_elif_1 = """
You pick up a bow and a quiver of arrows. You pull out an
arrow, knock it to the bow and pull the string back. You
Sight along the arrow at the head of a particularly ugly and
decomposed member of the walking dead and you let the arrow
...
"""
    ...
    print(se_gaurd_tower_string_intro)

    if bridge_problem_chain_explained <= 1:
        print(se_gaurd_tower_string_if)
        what_to_do = input("> ")
        ...
        print(se_gaurd_tower_string_elif_1)
        what_to_do = input("> ")
        ...
        print(se_gaurd_tower_string_else)
        what_to_do = input("> ")

        if "b" in what_to_do:
            courtyard()
        elif "c" in what_to_do:
            print(se_gaurd_tower_string_else_elif_1)
            se_gaurd_tower()
        else:
            se_gaurd_tower()
